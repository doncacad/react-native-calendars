...
class Calendar extends Component {
  ...
  static propTypes = {
    ...
    // how many past days to be shown, if this is set - autoHorizontalScroll will not wor
  ...
  constructor(props) {
    ...
    this.onHorizontalCalendarScroll = this.onHorizontalCalendarScroll.bind(
      this,
    );
    ...
    if (this.state.horizontal) {
      return (
        <ScrollView
          ...
          style={[this.style.monthView, {marginBottom: 20}]}
          horizontal
